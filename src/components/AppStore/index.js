...
class AppStore extends Component {
  ...
  getFilteredProjects = searchedApps => {
    ...
    const filteredProjects = searchedApps.filter(
      eachUser => eachUser.category === activeTabId,
    )
  ...
  onChangeApp = () => {
    ...
    const searchedProjects = appsList.filter(eachData =>
  ...
  render() {
    ...
    const searchedProjects = this.onChangeApp()

    const filteredProjects = this.getFilteredProjects(searchedProjects)
        ...
        <ul className="tabs-item-list">
          {tabsList.map(eachItem => (
            <TabItem
              ...
              clickOnTabItem={this.clickOnTabItem}
